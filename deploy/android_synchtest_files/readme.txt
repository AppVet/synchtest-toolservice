...
For proper operation of the this tool, the environment variable 
EXAMPLE_SYNCHTEST_FILES_HOME should be globally set to the path for this 
directory. For example:


EXAMPLE_SYNCHTEST_FILES_HOME = /home/<username>/example_synchtest_files

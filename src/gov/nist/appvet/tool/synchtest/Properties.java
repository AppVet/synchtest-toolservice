...
import gov.nist.appvet.tool.synchtest.util.Xml;
...
public class Properties {
    ...
    public static String ANDROID_SYNCHTEST_FILES_HOME = null;
    public static String LOG_DISPLAY_NAME = "ANDROID-SYNCHTEST";
    ...
    static {
	System.out.println("*** Starting Android SYNCHTEST Tool v" + version + " ***");
	...
	ANDROID_SYNCHTEST_FILES_HOME = System
		.getenv("ANDROID_SYNCHTEST_FILES_HOME");
	if (ANDROID_SYNCHTEST_FILES_HOME == null) {
	    System.err
		    .println("Environment variable ANDROID_SYNCHTEST_FILES_HOME not set.");
	}
	...
	TEMP_DIR = ANDROID_SYNCHTEST_FILES_HOME + "/apps";
	...
	CONF_DIR = ANDROID_SYNCHTEST_FILES_HOME + "/conf";
	if (!new File(CONF_DIR).exists()) {
	    System.err
		    .println("Directory $ANDROID_SYNCHTEST_FILES_HOME/conf does not exist.");
	}
	...
	LOGS_DIR = ANDROID_SYNCHTEST_FILES_HOME + "/logs";
